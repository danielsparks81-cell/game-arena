    ...
    <div className="flex w-full flex-col gap-3">
      ...
      <div className="flex flex-col gap-7 rounded-xl border border-neutral-800 bg-neutral-950/40 p-3">
        ...
        <div className="grid grid-cols-12 gap-2">
          ...
          <div className="group relative col-span-1 flex h-56 flex-col">
            <PileDisplay
              label="KO"
          ...
          <div className="col-span-10 grid grid-cols-5 gap-2">
            ...
            <div className="col-span-2 h-56" ref={schemeRef}>
            ...
            <div className="col-span-2 h-56" ref={mastermindRef}>
              <MastermindZone
                mmDef={mmDef}
          ...
          <div className="col-span-1 flex h-56 flex-col gap-1">
        ...
        <div className="grid grid-cols-12 gap-2">
          ...
          <div className="col-span-1 flex h-44 flex-col" ref={villainDeckRef}>
        ...
        <div className="grid grid-cols-12 gap-2">
          ...
          <div className="col-span-1 flex h-44 flex-col" ref={heroDeckRef}>
...
function CitySlot({
  ...
  if (onMoveDest) {
    ...
    return (
      <button
        type="button"
        onClick={onMoveDest}
        className="block w-full h-44 rounded-lg border-2 border-dashed border-sky-500 bg-sky-950/20 transition hover:bg-sky-900/30"
      >
        {inner}
      </button>
    );
  ...
  if (!card) {
    ...
    return (
      <div
        className="relative flex h-44 flex-col items-end justify-end rounded-lg p-2"
        style={{
  ...
  if (skrullHeroStrike !== undefined && def.kind === 'hero') {
    ...
    return (
      ...
      >
        <HeroCardArt def={def} wide height="h-44" />
        {/* SKRULL ribbon */}
        <div
  ...
  if (def.kind !== 'villain' && def.kind !== 'henchman') {
    return <div className="h-44 rounded-lg bg-neutral-900" />;
  }
...
function HQSlot({
  ...
  if (!card) {
    return (
      <div className="flex h-44 items-center justify-center rounded-lg border border-dashed border-neutral-800 text-[11px] text-neutral-600">
        empty
      </div>
    );
  }
  const def = getCard(card.cardId);
  if (def.kind !== 'hero') return <div className="h-44 rounded-lg bg-neutral-900" />;
  ...
  if (onFreeRecruit !== undefined) {
    ...
    return (
      ...
      >
        <HeroCardArt def={def} wide height="h-44" copies={copies} />
...
function SchemeZone({
  ...
  return (
    ...
    >
      ...
      {schemeDef.text && (
        <div className="mt-1 flex-1 space-y-1.5 overflow-hidden text-[14px] leading-snug">
  ...
  return (
    ...
    >
      ...
      {mmDef.text && (() => {
        ...
        return (
          <div className="mt-1 line-clamp-3 pr-7 text-[14px] leading-snug">
