...
export const QUEST1_FURNITURE: Q1Furn[] = [
  ...
  { kind: 'chest',           x: 12, y: 6,  w: 1, h: 1, los: false, rot: 0, gold: 84 },
  { kind: 'chest',           x: 13, y: 9,  w: 1, h: 1, los: false, rot: 0, gold: 120 },
...
export const QUEST1_MONSTERS: Q1Monster[] = [
  ...
  { kind: 'zombie',        x: 8,  y: 2 },
  { kind: 'zombie',        x: 8,  y: 4 },
  { kind: 'mummy',         x: 8,  y: 3, name: 'Guardian' },
  { kind: 'orc',           x: 5,  y: 7 },
  { kind: 'orc',           x: 13, y: 13 },
  { kind: 'orc',           x: 16, y: 10 },
  { kind: 'orc',           x: 8,  y: 17 },
  ...
  { kind: 'gargoyle',      x: 14, y: 10, name: 'Verag' },
];
