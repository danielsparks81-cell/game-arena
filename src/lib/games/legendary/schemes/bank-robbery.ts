...
// on each twist. The "+1[strike] per attached Bystander" rule already works
// (engine pre-existing). Loss uses `evilWinsAfterTwists: 8` as a placeholder
// for the "8 carried-away Bystanders" timer — proper escape-tracking still
// to be added. Card text preserves the official wording.
