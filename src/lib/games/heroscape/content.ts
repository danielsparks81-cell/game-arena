...
export const HS_CARDS: Record<string, HSCardDef> = {
  ...
  // ---- Thora's Vengeance GLADIATORS + Orm's Return BRUNAK (classic Wave 7/5, went live 2026-07-01) ----
  brunak: {
    id: 'brunak',
    name: 'Brunak',
    shortName: 'Brunak',
    ...
    species: 'Troll',
    unitClass: 'Troll',
    power: 'live', // Carry + Blood Hungry Special Attack (chain on kill) + Lava Resistant
  },
  crixus: {
    id: 'crixus',
    name: 'Crixus',
    ...
    species: 'Human',
    unitClass: 'Gladiator',
    power: 'live', // One Shield Defense (≥1 shield caps this attack's wounds at 1)
  },
  retiarius: {
    id: 'retiarius',
    name: 'Retiarius',
    ...
    species: 'Human',
    unitClass: 'Gladiator',
    power: 'live', // Net Trip 14 (d20 after moving; 14+ = his small/medium targets roll max 1 defense die this turn)
  },
  spartacus: {
    id: 'spartacus',
    name: 'Spartacus',
    ...
    species: 'Human',
    unitClass: 'Gladiator',
    power: 'live', // Gladiator Inspiration (all markers on Gladiators + one on him → +1 move/atk/def for the round)
  },
  capuan_gladiators: {
    id: 'capuan_gladiators',
    name: 'Capuan Gladiators',
    shortName: 'Capuan Gladiators',
    type: 'squad',
    figures: 3,
    life: 1,
    move: 5,
    ...
    unitClass: 'Gladiator',
    common: true,
    power: 'live', // Human Gladiator Hero Bonding + Initiative Advantage
    bonding: 'human_gladiator_hero',
  },
  // ---- Fields of Valor ESENWEIN VAMPIRES + their Rechets (classic Wave 7, went live 2026-07-01) ----
  cyprien_esenwein: {
    id: 'cyprien_esenwein',
    ...
    species: 'Undead',
    unitClass: 'Lord',
    power: 'live', // Life Drain + Chilling Touch (d20 wound bands) + STEALTH Flying (= flying + disengage)
    lifeDrain: true,
    flying: true,
    disengage: true,
  },
  iskra_esenwein: {
    ...
    species: 'Undead',
    unitClass: 'Duchess',
    power: 'live', // Life Drain + Summon the Rechets of Bogdan (d20 14+ after her turn) + Flying
    lifeDrain: true,
    flying: true,
  },
  sonya_esenwein: {
    ...
    species: 'Undead',
    unitClass: 'Lady',
    power: 'live', // Life Drain + Eternal Strength (+2 to Cyprien's Chilling Touch) + Eternal Heartbreak + Flying
    lifeDrain: true,
    flying: true,
  },
  marcu_esenwein: {
    ...
    species: 'Undead',
    unitClass: 'Devourer',
    power: 'live', // Life Drain + Eternal Hatred (17+ on reveal → an opponent controls him this turn) + Flying
    lifeDrain: true,
    flying: true,
  },
  rechets_of_bogdan: {
    id: 'rechets_of_bogdan',
    ...
    species: 'Undead',
    unitClass: 'Devourer',
    power: 'live', // Iskra's Summoning (start in reserve) + Lethal Sting (all skulls vs small/medium = destroyed) + Flying
    flying: true,
  },
};
...
export const HS_DRAFT_POOL: readonly string[] = [
  ...
  // Thora's Vengeance gladiators + Brunak (2026-07-01)
  'spartacus', 'crixus', 'retiarius', 'capuan_gladiators', 'brunak',
  // Fields of Valor Esenwein vampires + their bats
  'cyprien_esenwein', 'iskra_esenwein', 'sonya_esenwein', 'marcu_esenwein', 'rechets_of_bogdan',
];
...
export const CARD_IDENTITY: Record<string, { general: string; personality: string; world: string }> = {
  ...
  // Gladiators (Thora's Vengeance) + Brunak (Orm's Return)
  brunak: { general: 'Utgar', personality: 'Ferocious', world: 'Feylund' },
  crixus: { general: 'Einar', personality: 'Rebellious', world: 'Earth' },
  retiarius: { general: 'Einar', personality: 'Rebellious', world: 'Earth' },
  spartacus: { general: 'Einar', personality: 'Rebellious', world: 'Earth' },
  capuan_gladiators: { general: 'Einar', personality: 'Rebellious', world: 'Earth' },
  // Esenwein vampires + Rechets (Fields of Valor)
  cyprien_esenwein: { general: 'Utgar', personality: 'Terrifying', world: 'Feylund' },
  iskra_esenwein: { general: 'Utgar', personality: 'Terrifying', world: 'Feylund' },
  sonya_esenwein: { general: 'Utgar', personality: 'Terrifying', world: 'Feylund' },
  marcu_esenwein: { general: 'Utgar', personality: 'Terrifying', world: 'Feylund' },
  rechets_of_bogdan: { general: 'Utgar', personality: 'Terrifying', world: 'Feylund' },
};
...
export const ABILITIES: Record<string, Ability> = {
  ...
  // ---- Gladiators + Brunak (2026-07-01) ----
  'Blood Hungry Special Attack': { kind: 'active', text: "Range 1. Attack 4. If Brunak's Blood Hungry Special Attack destroys a figure, Brunak may attack again with his Blood Hungry Special Attack. Brunak may continue attacking with his Blood Hungry Special Attack until he does not destroy a figure." },
  'Lava Resistant': { kind: 'passive', text: "Brunak never rolls for molten lava damage or lava field damage and he does not have to stop in molten lava spaces." },
  'One Shield Defense': { kind: 'passive', text: "When rolling defense dice, if Crixus rolls at least one shield, the most wounds Crixus may take for this attack is one." },
  'Net Trip 14': { kind: 'active', text: "After moving and before attacking, roll the 20-sided die. If you roll a 14 or higher, any small or medium figure attacked by Retiarius this turn may roll no more than 1 die for defense." },
  'Gladiator Inspiration': { kind: 'passive', text: "If all Order Markers for a round are placed on Gladiator Army Cards, and at least one Order Marker is placed on Spartacus, then all Gladiators you control (except Spartacus) become inspired. Inspired Gladiators add one to their Move number and add 1 extra attack die and defense die for the rest of the round." },
  'Human Gladiator Hero Bonding': { kind: 'passive', text: "Before taking a turn with the Capuan Gladiators, you may first take a turn with any Human Gladiator Hero you control." },
  'Initiative Advantage': { kind: 'passive', text: "If all of your order markers are on Gladiator Army Cards, you may add 1 to your initiative roll for every order marker on the Capuan Gladiators' Army Card, up to a maximum of +3 for Initiative Advantage." },
  // ---- Esenwein vampires + Rechets (2026-07-01) ----
  'Life Drain': { kind: 'passive', text: "Each time this figure destroys a figure, you may remove a wound marker from this Army Card. It cannot Life Drain destructible objects." },
  'Chilling Touch': { kind: 'active', text: "After moving and before attacking, Cyprien Esenwein may attempt a Chilling Touch. To do this, choose a figure adjacent to Cyprien Esenwein and roll the 20-sided die. If you roll 1-12, nothing happens. 13-15: the chosen figure receives 1 wound. 16-17: 2 wounds. 18-19: 3 wounds. 20 or higher: 6 wounds. Chilling Touch does not affect Soulborgs or destructible objects." },
  'Stealth Flying': { kind: 'passive', text: "When counting spaces for movement, ignore elevations. This figure may fly over water without stopping, pass over figures without becoming engaged, and fly over obstacles such as ruins. When this figure starts to fly, if it is engaged it will NOT take any leaving engagement attacks." },
  'Summon the Rechets of Bogdan': { kind: 'active', text: "After taking a turn with Iskra Esenwein, you may attempt to summon the Rechets of Bogdan if they are in your army and they have not yet been successfully summoned. Roll the 20-sided die. If you roll a 14 or higher, you must place all 3 Rechets of Bogdan on empty spaces within 6 clear sight spaces of Iskra Esenwein. Any Rechets that you cannot place are immediately destroyed and cannot be summoned again. When the Rechets are summoned, you may immediately take a turn with them." },
  'Eternal Strength': { kind: 'passive', text: "Anytime you roll the 20-sided die for Cyprien Esenwein's Chilling Touch, you may add 2 to your die roll." },
  'Eternal Heartbreak': { kind: 'passive', text: "If you control Cyprien Esenwein and he is destroyed, Sonya Esenwein immediately receives 2 wounds." },
  'Eternal Hatred': { kind: 'passive', text: "After revealing an order marker on this card, you must roll the 20-sided die. If you roll a 17 or higher, choose an opponent. That opponent will now control Marcu Esenwein for the remainder of your turn, but will not be able to view any unrevealed order markers on his card. At the end of that turn, control of Marcu returns to you." },
  "Iskra's Summoning": { kind: 'passive', text: "Rechets of Bogdan do not start the game on the battlefield. They must be summoned onto the battlefield by Iskra Esenwein." },
  'Lethal Sting': { kind: 'passive', text: "When rolling attack dice against a small or medium figure, if a Rechet of Bogdan rolls a skull on every die, the defending figure cannot roll any defense dice and is immediately destroyed." },
};
...
export const CARD_ABILITIES: Record<string, string[]> = {
  ...
  // Gladiators + Brunak
  brunak: ['Carry', 'Blood Hungry Special Attack', 'Lava Resistant'],
  crixus: ['One Shield Defense'],
  retiarius: ['Net Trip 14'],
  spartacus: ['Gladiator Inspiration'],
  capuan_gladiators: ['Human Gladiator Hero Bonding', 'Initiative Advantage'],
  // Esenwein vampires + Rechets
  cyprien_esenwein: ['Life Drain', 'Chilling Touch', 'Stealth Flying'],
  iskra_esenwein: ['Life Drain', 'Summon the Rechets of Bogdan', 'Flying'],
  sonya_esenwein: ['Life Drain', 'Eternal Strength', 'Eternal Heartbreak', 'Flying'],
  marcu_esenwein: ['Life Drain', 'Eternal Hatred', 'Flying'],
  rechets_of_bogdan: ["Iskra's Summoning", 'Lethal Sting', 'Flying'],
};
